...
2. [공통 사양](#2-공통-사양)
3. [인증 (Auth)](#3-인증-auth)
4. [표시 학기 (Semesters)](#4-표시-학기-semesters)
5. [적재 현황 (Courses)](#5-적재-현황-courses)
6. [데이터 업데이트 (Sync)](#6-데이터-업데이트-sync)
7. [진행률 표현](#7-진행률-표현)
8. [도메인 사전](#8-도메인-사전)
9. [에러 코드 목록](#9-에러-코드-목록)
10. [백엔드 구현 요구](#10-백엔드-구현-요구)
11. [미확정·실측 확인 항목](#11-미확정실측-확인-항목)
12. [문서 정정 사항](#12-문서-정정-사항)
...
**문서 작성일**: 2026-08-07 (v1.0) · **개정일**: 2026-08-07 (v1.1)
**문서 버전**: v1.1
